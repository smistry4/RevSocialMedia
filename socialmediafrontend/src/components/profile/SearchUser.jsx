      ...
      <div className="w-full mx-auto" ref={searchContainerRef}>
        <form class="relative" onSubmit={handleSubmit}>
          ...
          <div class="relative">
            ...
            <button
              type="submit"
              class="text-white absolute my-auto end-3.5 bottom-4 bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Search
            </button>
          </div>
